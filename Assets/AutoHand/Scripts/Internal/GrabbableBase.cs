...
namespace Autohand {
    ...
    public class GrabbableBase : MonoBehaviour{
        ...
        //added by VRB team
        public Vector3 IntialPositon;
        public Quaternion IntialRotation;
    ...
    #endif
            IntialPositon = transform.localPosition;
            IntialRotation = transform.localRotation;
            //Debug.Log("Intial positon for "+transform.name+" is:" + transform.localPosition);
            //Debug.Log("Intial rotaion is:" + transform.localRotation);
